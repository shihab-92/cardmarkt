                  ...
                  <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input id="name" class="form-control col-md-7 col-xs-12"  name="Username" placeholder="User name e.g Jon90" required="required" type="text">
                        </div>
                     </div>
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input id="first-name" class="form-control col-md-7 col-xs-12"  name="firstName" placeholder="first name e.g Jon" required="required" type="text">
                        </div>
                     </div>
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input id="last-name" class="form-control col-md-7 col-xs-12"  name="lastName" placeholder="last name e.g Doe" required="required" type="text">
                        </div>
                     </div>
                     <div class="item form-group">
