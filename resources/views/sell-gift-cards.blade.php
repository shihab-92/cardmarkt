...
<div class="content">
	<div class="container">
		<div class="col-md-4 cardls_dresses_grid_left">
			<div class="cardls_dresses_grid_left_grid">
				<h3>Categories</h3>
				<div class="cardls_dresses_grid_left_grid_sub">
		...
		<div class="col-md-8 col-sm-8 women-dresses">
			<div class="women-set1">
				<h3 style="font-size: 1.5em;color: #212121;padding-left: 0em;position: relative;margin: 1em;text-align: left;">Products</h3>
					...
					<a href="single.html"><div class="product-img">
						...
						<div class="p-mask">
							<form action="#" method="post">
								...
								<input type="hidden" name="cardls1_item" value="Pencil dress" /> 
					...
					<a href="single.html"><div class="product-img">
						...
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
								<input type="hidden" name="cardls1_item" value="Casual dress" /> 
