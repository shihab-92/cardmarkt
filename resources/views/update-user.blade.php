            ...
            <div class="x_panel">
               ...
               <div class="x_content">
                  <form class="form-horizontal form-label-left" novalidate action="/update-user/{{$editUserInfo->id}}" method="POST">
                     ...
                     <div class="item form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type">Role <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <select name="role" class="form-control col-md-7 col-xs-12" required>
                              <option value="">Select Role</option>
                              <option value="admin" @if($editUserInfo->role == 'admin')  selected @endif>Admin</option>
                              <option value="user" @if($editUserInfo->role == 'user')  selected @endif>User</option>
                           </select>
                        </div>
                     </div>
                     <div class="item form-group">
