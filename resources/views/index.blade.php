								...
								<a href="single.html"><div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="cardls1_item" value="Handbag" /> 
								...
								<a href="single.html"><div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="cardls1_item" value="Eye makeup" /> 
											<input type="hidden" name="amount" value="90.00" /> 
											<button type="submit" class="cardls-cart pcardls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
										</form>
									</div>
								...
								<a href="single.html"><div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="cardls1_item" value="Gold makeup" /> 
											<input type="hidden" name="amount" value="60.00" /> 
											<button type="submit" class="cardls-cart pcardls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
										</form>
									</div>
								...
								<a href="single.html"><div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="cardls1_item" value="Tya Makeup kit" /> 
											<input type="hidden" name="amount" value="120.00" /> 
											<button type="submit" class="cardls-cart pcardls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
										</form>
									</div>
								...
								<a href="single.html"><div class="product-img">
									...
									<div class="p-mask">
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
											<input type="hidden" name="cardls1_item" value="Vega Brushes" /> 
											<input type="hidden" name="amount" value="60.00" /> 
											<button type="submit" class="cardls-cart pcardls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
										</form>
									</div>
									...
									<a href="single.html"><div class="product-img">
										...
										<div class="p-mask">
											<form action="#" method="post">
												<input type="hidden" name="cmd" value="_cart" />
												<input type="hidden" name="add" value="1" /> 
												<input type="hidden" name="cardls1_item" value="Eye shades" /> 
												<input type="hidden" name="amount" value="60.00" /> 
												<button type="submit" class="cardls-cart pcardls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
											</form>
										</div>
